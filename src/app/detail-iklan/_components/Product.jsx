...
const Product = () => {
  ...
  return (
    <div className="relative w-[48.4%] rounded-xl bg-white font-inter text-[10px] font-medium text-neutral-400 md:w-[23.8%]">
      ...
      <div className=" mt-[10px] px-[12px] pb-[15px] md:mt-[15px] md:px-[20px] md:pb-[20px]">
        ...
        <h3
          className="md:text-md mt-[10px] text-xs font-medium text-zinc-800"
          onClick={() => router.push("/detail-iklan")}
        >
          Tesla Rodster
        </h3>
